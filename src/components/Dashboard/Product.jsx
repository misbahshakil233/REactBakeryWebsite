...
const Product = () => {
  return (
    <section id="products" className="p-6 text-center">
      {/* Heading */}
      <h2 className="text-5xl font-semibold mb-6 text-black hover:text-4xl transition-all duration-300 font-[YourCustomFont] relative">
        What We <span className="text-rose-950">Do</span>
        {/* Decorative Underline */}
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-slate-600 rounded-full mt-4"></div>
      </h2>
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        <div className="max-w-xs w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 hover:bg-slate-500 hover:text-white transition-all duration-300">
          ...
          />
          <div className="p-4">
            <h3 className="text-xl font-semibold text-black hover:text-2xl transition-all duration-300">Butter Milk Biscuits</h3>
        ...
        <div className="max-w-xs w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 hover:bg-slate-500 hover:text-white transition-all duration-300">
          ...
          />
          <div className="p-4">
            <h3 className="text-xl font-semibold text-black hover:text-2xl transition-all duration-300">Cake</h3>
            <p className="text-gray-600 mt-2">
        ...
        <div className="max-w-xs w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 hover:bg-slate-500 hover:text-white transition-all duration-300">
          ...
          />
          <div className="p-4">
            <h3 className="text-xl font-semibold text-black hover:text-2xl transition-all duration-300">Crunchy Snacks</h3>
            <p className="text-gray-600 mt-2">
        ...
        <div className="max-w-xs w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 hover:bg-slate-500 hover:text-white transition-all duration-300">
          ...
          />
          <div className="p-4">
            <h3 className="text-xl font-semibold text-black hover:text-2xl transition-all duration-300">Delicious Dessert</h3>
            <p className="text-gray-600 mt-2">
